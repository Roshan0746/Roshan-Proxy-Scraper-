...
# --- [ SECURE CONFIG ] ---
# Railway Dashboard -> Variables mein ye names add karna
            ...
            async with session.get(url, proxy=proxy_url) as response:
                if response.status == 200:
                    ...
                    msg = (
                        ...
                        f"📶 **Net:** {flag} {isp}\n"
                        "───────────────────\n"
                        f"✅ **Verified & Active** • ⏱ {time.strftime('%H:%M')}"
                    )
